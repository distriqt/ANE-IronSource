...
package
{
	import com.distriqt.test.chartboost.Main;
	...
	/**	
	 * Sample application for using the Chartboost Native Extension
	 */
	public class TestChartboost extends Sprite
	{
		////////////////////////////////////////////////////////
		//	CONSTANTS
		//
		 ...
		 *  Constructor
		 */
		public function TestChartboost()
		{
			super();
			if(this.stage)
			{
