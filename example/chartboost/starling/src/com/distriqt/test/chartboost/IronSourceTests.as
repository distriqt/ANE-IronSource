 ...
 */
package com.distriqt.test.chartboost
{
	import com.distriqt.extension.ironsource.IronSource;
	import com.distriqt.extension.ironsource.chartboost.Chartboost;
...
//					IronSource.instance.addEventListener( "onRewardedVideoAdClicked", onRewardedVideoAdClicked );
					...
					log( "Chartboost Version: " + Chartboost.instance.nativeVersion );
