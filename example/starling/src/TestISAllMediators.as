...
package
{
	import com.distriqt.test.isallmediators.Main;
	...
	/**	
	 * Sample application for using the ISAllMediators Native Extension
	 */
	public class TestISAllMediators extends Sprite
	{
		////////////////////////////////////////////////////////
		//	CONSTANTS
		//
		 ...
		 *  Constructor
		 */
		public function TestISAllMediators()
		{
			super();
			if(this.stage)
			{
